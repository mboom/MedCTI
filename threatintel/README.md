The ThreatIntel package provides a simulation for a service for sharing threat intelligence.
...
Compile the ThreatIntel service:

    protoc --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative threatintel.proto
